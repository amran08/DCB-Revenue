    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue-hoki">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-pencil-square-o fa-lg"></i><?= __('Edit Building File') ?>
                </div>
                <div class="tools">
            ...
            <div class="portlet-body">
                <?= $this->Form->create($buildingFile, ['class' => 'form-horizontal', 'role' => 'form', 'type' => 'file']) ?>
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        ...
                        ?>
                        <span class="label label-info">Previous File</span>
                        <?php echo $buildingFile['file_url']; ?>

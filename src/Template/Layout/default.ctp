...
<div class="page-header navbar navbar-fixed-top">
    ...
    <div class="page-header-inner">
        ...
        <div class="page-logo">
            ...
            <h3 style="color: white; font-weight: bold"><?= __('DCB Revenue Collection System') ?></h3>
                    ...
                    <li class="dropdown dropdown-user dropdown-dark">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
                           data-close-others="true">
                            <span
                                class="username username-hide-on-mobile"><?= $user['full_name_en'] ? $user['full_name_en'] : $user['full_name_bn']; ?></span>
                            <?php
                            if (isset($user['picture']) && strlen($user['picture']) > 0) {
                                ?>
                                <img alt="" class="img-circle"
                                     src="<?= $this->request->webroot; ?><?= $user['picture'] ?>"/>
                                <?php
                            } else {
                                ?>
                                <img alt="" class="img-circle"
                                     src="<?= $this->request->webroot; ?>assets/admin/layout4/img/avatar.png"/>
                                <?php
                            }
                            ?>
                        </a>
...
<script src="<?= $this->request->webroot; ?>assets/global/plugins/bootstrap-confirmation/bootstrap-confirmation.js"
        type="text/javascript"></script>
...
<script src="<?php echo $this->request->webroot; ?>js/jq/jqxgrid.export.js" type="text/javascript"></script>
...
<script src="<?php echo $this->request->webroot; ?>js/overhang.min.js" type="text/javascript"></script>

<link rel="stylesheet" type="text/css" href="<?php echo $this->request->webroot;?>js/overhang.min.css" />

<script src="<?php echo $this->request->webroot; ?>js/Cantonment_validation.js" type="text/javascript"></script>
<!--amran-->
...
<script src="<?php echo $this->request->webroot; ?>assets/global/plugins/select2/select2.min.js"
        type="text/javascript"></script>
<link href="<?php echo $this->request->webroot; ?>assets/global/plugins/select2/select2.css" rel="stylesheet"
      type="text/css"/>

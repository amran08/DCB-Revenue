            ...
            <div class="portlet-body">
                <div class="table-scrollable">
                    <table class="table table-bordered table-hover">
                                                                                                        <tr>
                                    <th><?= __('Division') ?></th>
                                    <td><?= $user->has('division') ? $this->Html->link($user->division->id, ['controller' => 'Divisions', 'action' => 'view', $user->division->id]) : '' ?></td>
                                </tr>
                                                                                                        <tr>
                                    <th><?= __('District') ?></th>
                                    <td><?= $user->has('district') ? $this->Html->link($user->district->name_en, ['controller' => 'Districts', 'action' => 'view', $user->district->id]) : '' ?></td>
                                </tr>
                                                                                                        <tr>
                                    <th><?= __('Upazila') ?></th>
                                    <td><?= $user->has('upazila') ? $this->Html->link($user->upazila->name_bd, ['controller' => 'Upazilas', 'action' => 'view', $user->upazila->id]) : '' ?></td>
                                </tr>
                                                                                                        <tr>
                                    <th><?= __('User Group') ?></th>
                                    ...
                                    <td><?= $this->Number->format($user->designation_id) ?></td>
                                </tr>

...
/**
 * ShopAllotmentInfosFixture
 *
 */
class ShopAllotmentInfosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'name_bn' => ['type' => 'string', 'length' => 100, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'mobile_number' => ['type' => 'string', 'length' => 100, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'status' => 1,
            'create_time' => '2016-10-10 06:58:15',
            'update_time' => '2016-10-10 06:58:15'
        ],
    ];
}
